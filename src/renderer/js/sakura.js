...
var Sakura = function Sakura(selector, options) {
  ...
  function elementInViewport(el) {
    ...
    // Проверяем, что элемент не ушел слишком далеко вверх или в стороны
    return rect.top >= -200 && rect.left >= -200 && 
  ...
  this.createPetal = function () {
    ...
    PrefixedEvent(petal, 'AnimationEnd', function () {
      petal.remove(); // Всегда удаляем лепесток после завершения анимации
